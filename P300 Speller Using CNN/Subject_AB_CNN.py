...
#Load Data
x_train = np.load('P300 Speller Using CNN/datasets/ab_signal_train.npy')
x_test = np.load('P300 Speller Using CNN/datasets/a_signal_test.npy')
y_train = np.load('P300 Speller Using CNN/datasets/ab_type_train.npy').astype(int)
...
xb_test = np.load('P300 Speller Using CNN/datasets/b_signal_test.npy')
yb_test = np.load('P300 Speller Using CNN/datasets/a_type_test.npy').astype(int)

p300 = keras.models.load_model('Models/Base_Model.h5')
from keras.optimizers import Adam  # Or any other optimizer you're using
